...
public class AddFruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //侧滑菜单
        mActionBar.setData(myActivity,"编辑地址信息", R.drawable.ic_back, 0, 0, getResources().getColor(R.color.colorPrimary), new ActionBar.ActionBarClickListener() {
            @Override
    ...
    public void save(View view){
        ...
        if ("".equals(issuer)) {
            Toast.makeText(myActivity,"人数不能为空", Toast.LENGTH_LONG).show();
            return;
        }
        if ("".equals(img)) {
